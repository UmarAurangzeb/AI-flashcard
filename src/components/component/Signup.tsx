            ...
            <div className="bg-cover w-screen h-screen flex justify-center items-center bg-slate-800 text-white">
                <div className="bg-slate-900 w-3/5 md:w-2/5 h-fit py-6 pb-20 flex flex-col items-center max-w-2xl  border-gray-50 border-[1px] ">
                    ...
                    <form
                        ...
                        className="w-full"
                    >
                        <button type="submit" className="flex bg-black py-2 mb-4 w-7/12 md:w-8/12 mx-auto hover:bg-zinc-800 12" onClick={() => {
                            signIn("github", { redirectTo: "/dashboard" })
                        }}><span><FaGithub className="mt-1 ml-1" /></span><h3 className="flex-grow">Continue with Github</h3></button>
                    </form>
                    <form
                        action={'#'}
                        className="w-full"
                    ...
                    >
                        <button type="submit" className="flex bg-white  text-black py-1 mx-auto w-7/12 md:w-8/12 hover:bg-gray-500   " onClick={() => {
                            signIn("google", { redirectTo: "/dashboard" })
                        }}><span><FaGoogle className="mt-1 ml-1" /></span><h3 className="flex-grow">Continue with Google</h3></button>
                    </form>
                </div>
            </div >
        </>
